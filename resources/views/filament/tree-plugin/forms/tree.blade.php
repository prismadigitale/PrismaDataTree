    ...
    <div {{ 
        ...
        >
            ...
            >
                ...
                {{ __('filament.tree-plugin.filament-tree.components.tree.buttons.deselect_all.label') }}
                </span>
                <span x-show="!areAllCheckboxesChecked">
                    {{ __('filament.tree-plugin.filament-tree.components.tree.buttons.select_all.label') }}
                </span>
            </x-filament::link>
            ...
            <x-filament::icon-button
                ...
                color="secondary"
                label="{{ __('filament.tree-plugin.filament-tree.components.tree.buttons.expand_all.label') }}"
            ...
            <x-filament::icon-button
                ...
                color="secondary"
                label="{{ __('filament.tree-plugin.filament-tree.components.tree.buttons.collapse_all.label') }}"
        ...
        <div>
            @foreach($getOptions() as $node)
                <x-filament.tree-plugin.forms.tree.group :node="$node"/>
            @endforeach
        </div>
    </div>
</x-dynamic-component>
